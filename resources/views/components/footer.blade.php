    ...
    <div class="row justify-content-around">    
        <div col-12 col-md-6 col-sm-6>
            <ul class="social-icons">   
                <li><a href="https://www.instagram.com/"><i class="fa-brands fa-instagram fa-xl" style="color: #db9320"></i></a></li>
                <li><a href="https://it-it.facebook.com/"><i class="fa-brands fa-facebook fa-xl" style="color: #db9320"></i></a></li>
            ...
            <ul class="menu fw-bold">  
                ...
                <li><a style="color: #db9320;" class="text-decoration-none" href="{{route('team.work')}}">Chi siamo</a></li>
            </ul>
        </div>
    </div>
</footer>